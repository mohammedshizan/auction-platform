      ...
      <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] gap-7 flex flex-col min-h-screen py-4 justify-center">
        <div>
          ...
          <p className="text-xl text-stone-600 text-justify mt-5">
            Welcome to Winning Bids, the ultimate destination for online auctions
            and bidding excitement. Established in 2022, we aim to redefine the
        ...
        <div>
          ...
          <p className="text-xl text-stone-600 text-justify">
            At Winning Bids, our mission is to revolutionize how people buy and sell
        ...
        <div>
          ...
          <p className="text-xl text-stone-600 text-justify">
            Founded by Shizan, Winning Bids was created from a deep-seated passion
            ...
            innovate, Shizan set out to design a platform that simplifies the
            auction process while retaining its excitement and charm. Today,
            Winning Bids stands as a testament to our dedication to excellence,
        ...
        <div>
          ...
          <p className="text-xl text-stone-600 text-justify">
            ...
            reach, or simply explore a world of possibilities, Winning Bids welcomes
        ...
        <div>
          <p className="text-[#4749e9] text-xl font-bold mb-3">
            Thank you for choosing Winning Bids. We are honored to have you with us
